...
if ($products_in_cart) {
    ...
    foreach ($itemlist as $k => $v) {
        $subtotal = 500;
        // $subtotal += (float)$v->regular_price * (int)$products_in_cart[$v->id];
    }
}
?>
    ...
    <form action="index.php?page=cart" method="post">
        <table>
            ...
            <tbody>
                ...
                <?php else: ?>
                <?php foreach ($itemlist as $k => $product): ?>
                <tr>
                    <td class="img">
                        <a href="index.php?page=product&id=<?=$product['id']?>">
                            <img src="<?=$product->images[0]->src?>" width="50" height="50" alt="<?=$product->name?>">
                        </a>
                    </td>
                    <td>
                    ...
                    <td class="price">&dollar;<?=$product->regular_price?></td>
                    <td class="quantity">
                        <input type="number" name="quantity-<?=$product->id?>" value="<?=$products_in_cart[$product->id]?>" min="1" max="<?=$product->stock_quantity?>" placeholder="Quantity" required>
                    </td>
